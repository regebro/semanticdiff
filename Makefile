...
update-diff-match-patch:
	wget $(dfm_source_2) -O $(root_dir)/semanticdiff/_diff_match_patch_py2.py
	wget $(dfm_source_3) -O $(root_dir)/semanticdiff/_diff_match_patch_py3.py

flake:
	flake8 semanticdiff --exclude *diff_match_patch*.py
